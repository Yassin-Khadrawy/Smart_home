...
# 13 "./MCAL_layer/mcal_layer_init.h"
# 1 "./MCAL_layer/ADC/hal-adc.h" 1
# 12 "./MCAL_layer/ADC/hal-adc.h"
...
# 12 "./MCAL_layer/ADC/hal-adc.h" 2

# 1 "./MCAL_layer/ADC/../mcal_std_types.h" 1
# 10 "./MCAL_layer/ADC/../mcal_std_types.h"
...
# 10 "./MCAL_layer/ADC/../mcal_std_types.h" 2

# 1 "./MCAL_layer/compiler.h" 1
# 11 "./MCAL_layer/ADC/../mcal_std_types.h" 2
# 36 "./MCAL_layer/ADC/../mcal_std_types.h"
...
# 13 "./MCAL_layer/ADC/hal-adc.h" 2

# 1 "./MCAL_layer/ADC/../interrupts/internal_interrupts.h" 1
# 13 "./MCAL_layer/ADC/../interrupts/internal_interrupts.h"
# 1 "./MCAL_layer/ADC/../interrupts/config_interrupts.h" 1
# 15 "./MCAL_layer/ADC/../interrupts/config_interrupts.h"
# 1 "./MCAL_layer/ADC/../interrupts/../../MCAL_layer/GPIO/hal_gpio.h" 1
# 15 "./MCAL_layer/ADC/../interrupts/../../MCAL_layer/GPIO/hal_gpio.h"
# 1 "./MCAL_layer/ADC/../interrupts/../../MCAL_layer/GPIO/hal_gpio_config.h" 1
# 15 "./MCAL_layer/ADC/../interrupts/../../MCAL_layer/GPIO/hal_gpio.h" 2

# 1 "./MCAL_layer/ADC/../interrupts/../../MCAL_layer/GPIO/../device_config.h" 1
# 16 "./MCAL_layer/ADC/../interrupts/../../MCAL_layer/GPIO/hal_gpio.h" 2
# 33 "./MCAL_layer/ADC/../interrupts/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum
{
    LOW,
    HIGH,
...
# 15 "./MCAL_layer/ADC/../interrupts/config_interrupts.h" 2

# 1 "./MCAL_layer/ADC/../interrupts/config_gen_interrupts.h" 1
# 16 "./MCAL_layer/ADC/../interrupts/config_interrupts.h" 2
# 65 "./MCAL_layer/ADC/../interrupts/config_interrupts.h"
typedef enum
{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY,
}interrupt_priority_cfg;
# 13 "./MCAL_layer/ADC/../interrupts/internal_interrupts.h" 2
# 234 "./MCAL_layer/ADC/../interrupts/internal_interrupts.h"
typedef void(*InterruptHandler)(void);
# 14 "./MCAL_layer/ADC/hal-adc.h" 2
# 98 "./MCAL_layer/ADC/hal-adc.h"
typedef enum{
    ADC_CHANNEL_AN0 = 0,
    ADC_CHANNEL_AN1,
    ADC_CHANNEL_AN2,
...
typedef struct{
    ...
    unit8 voltage_reference : 1;
    unit8 result_format : 1;
...
# 1 "./MCAL_layer/hal_EEPROM/eeprom.h" 1
# 27 "./MCAL_layer/hal_EEPROM/eeprom.h"
...
# 31 "./MCAL_layer/Timer2/hal_timer2.h"
typedef enum
{
...
# 1 "./MCAL_layer/USART/mcal_usart.h" 1
# 84 "./MCAL_layer/USART/mcal_usart.h"
typedef enum
{
...
# 23 "./MCAL_layer/mcal_layer_init.h" 2
# 34 "./MCAL_layer/mcal_layer_init.h"
...
# 12 "./ECU_layer/LED/ecu_led_config.h"
# 1 "./ECU_layer/LED/ecu_led.h" 1
# 12 "./ECU_layer/LED/ecu_led_config.h" 2
...
# 1 "./ECU_layer/relay/ecu_realy_config.h" 1
...
# 1 "./ECU_layer/motor_dc/ecu_motor_dc.h" 1
# 12 "./ECU_layer/motor_dc/ecu_motor_dc.h"
# 1 "./ECU_layer/motor_dc/ecu_motor_dc.h" 1
# 12 "./ECU_layer/motor_dc/ecu_motor_dc.h" 2
# 24 "./ECU_layer/motor_dc/ecu_motor_dc.h"
typedef struct
{
...
# 29 "./ECU_layer/seven_segment/ecu_seven_segment.h"
typedef enum
{
...
# 11 "./ECU_layer/keypad/ecu_keypad_cfg.h"
# 1 "./ECU_layer/keypad/ecu_keypad.h" 1
# 11 "./ECU_layer/keypad/ecu_keypad_cfg.h" 2
...
# 1 "./ECU_layer/LCD_NEW/ecu_lcd_new.h" 1
# 13 "./ECU_layer/LCD_NEW/ecu_lcd_new.h"
# 1 "./ECU_layer/LCD_NEW/ecu_lcd_new_cfg.h" 1
# 13 "./ECU_layer/LCD_NEW/ecu_lcd_new.h" 2
# 41 "./ECU_layer/LCD_NEW/ecu_lcd_new.h"
typedef struct
{
    pin_config_t lcd_rs;
...
# 1 "./ECU_layer/DS1307/ecu_DS1307.h" 1
# 15 "./ECU_layer/DS1307/ecu_DS1307.h"
...
# 1 "./ECU_layer/TC74/ecu_TC74.h" 1
# 14 "./ECU_layer/TC74/ecu_TC74.h"
...
# 1 "./ECU_layer/24C01C/ecu_24C01C.h" 1
# 13 "./ECU_layer/24C01C/ecu_24C01C.h"
...
# 1 "./ECU_layer/LDR/ecu_ldr.h" 1
# 32 "./ECU_layer/LDR/ecu_ldr.h"
void ADC_Init_chat();
void PWM_Init();
...
extern keypad_t password_keypad;
extern led_t led_outdoor;
extern dc_motor_t locker;
extern mssp_i2c_t i2c_obj;
extern pin_config_t speaker;
extern pin_config_t PIR;
extern led_t PIR_led;
extern button_t on_keypad;
extern ccp_t PWM_LED;
extern timer2_t timer_pwm;
extern timer0_t timer0;
extern timer1_t timer1;
extern adc_conf_t adc;
...
void correct_incorrect_password(void)
{
    ...
    if((password_match == 4321) && (passowrd_counter == 4))
    {
        ...
        MSSP_I2C_Master_call_slave(&i2c_obj, 0x60 , 'a' , &ACK_Slave);
...
void I2C_DS1307_read(void)
{
    I2C_Real_Time_Read_DS1307(&i2c_obj, 0XD0 , 0x00 , &DS1307_read_value_0x00 , &DS1307_ACK_read_value_0x00);
    I2C_Real_Time_Read_DS1307(&i2c_obj, 0XD0 , 0x01 , &DS1307_read_value_0x01 , &DS1307_ACK_read_value_0x01);
    I2C_Real_Time_Read_DS1307(&i2c_obj, 0XD0 , 0x02 , &DS1307_read_value_0x02 , &DS1307_ACK_read_value_0x02);
    I2C_Real_Time_Read_DS1307(&i2c_obj, 0XD0 , 0x04 , &DS1307_read_value_0x04 , &DS1307_ACK_read_value_0x04);
    I2C_Real_Time_Read_DS1307(&i2c_obj, 0XD0 , 0x05 , &DS1307_read_value_0x05 , &DS1307_ACK_read_value_0x05);
    I2C_Real_Time_Read_DS1307(&i2c_obj, 0XD0 , 0x06 , &DS1307_read_value_0x06 , &DS1307_ACK_read_value_0x06);
}
...
void I2C_transfer_data(void)
{
    MSSP_I2C_Master_call_slave(&i2c_obj, 0x60 , TC74_read_value , &ACK_Slave);
    MSSP_I2C_Master_call_slave(&i2c_obj, 0x60 , 1 , &ACK_Slave);
    MSSP_I2C_Master_call_slave(&i2c_obj, 0x60 , DS1307_read_value_0x00 , &ACK_Slave);
    MSSP_I2C_Master_call_slave(&i2c_obj, 0x60 , DS1307_read_value_0x01 , &ACK_Slave);
    MSSP_I2C_Master_call_slave(&i2c_obj, 0x60 , DS1307_read_value_0x02 , &ACK_Slave);
    MSSP_I2C_Master_call_slave(&i2c_obj, 0x60 , DS1307_read_value_0x04 , &ACK_Slave);
    MSSP_I2C_Master_call_slave(&i2c_obj, 0x60 , DS1307_read_value_0x05 , &ACK_Slave);
    MSSP_I2C_Master_call_slave(&i2c_obj, 0x60 , DS1307_read_value_0x06 , &ACK_Slave);
}
...
void correct_incorrect_password_indoor(void)
{
    ...
    if((password_match_indoor == 8765) && (passowrd_counter_indoor == 4))
    {
        ...
        MSSP_I2C_Master_call_slave(&i2c_obj, 0x60 , 'b' , &ACK_Slave);
